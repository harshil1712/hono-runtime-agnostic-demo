...
declare class Container<Env = unknown> extends DurableObject<Env> {
    ...
    private alarmSleepPromise;
    private alarmSleepResolve;
...
export { Container, type ContainerEventHandler, type ContainerMessage, type ContainerOptions, type ContainerStartConfigOptions, getContainer, loadBalance };
